...
class TrailDetailTransformer extends TransformerAbstract
{
...
//        //查询客户title
//        $principal = DB::table('contacts')//
//        ->where('contacts.id', $trail->contact_id)
//            ->select('contacts.id')->first();
//        $array['contacts']['data']['id'] = $principal->id;
//        //查询艺人
...
//        $array['stars_name'] = $starsInfo;
    ...
    public function includeProject(Trail $trail)
    {
        ...
        return $this->item($project, new ProjectFilterTransformer());
    }
