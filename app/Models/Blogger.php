...
//    use OperateLogTrait;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        if(starts_with($path,"signing")){//如果接口地址以signing开头则是签约中的艺人
            self::$model_dic_id = DataDictionarie::SIGNING_BLOGGER;
        }
    }
    protected static function boot()
    {
        parent::boot(); // TODO: Change the autogenerated stub
        if (self::$model_dic_id == DataDictionarie::BLOGGER){
            static::addGlobalScope('hh',function (Builder $builder){
                $builder->whereIn('sign_contract_status',[SignContractStatus::ALREADY_SIGN_CONTRACT,SignContractStatus::ALREADY_TERMINATE_AGREEMENT]);
            });
        }
        if (self::$model_dic_id == DataDictionarie::SIGNING_BLOGGER){
            static::addGlobalScope('hh',function (Builder $builder){
                $builder->whereIn('sign_contract_status',SignContractStatus::SIGN_CONTRACTING);
            });
        }
    }
